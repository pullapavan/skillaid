...
function RoboWar() {
    ...
    const submitDetails = async () => {
        ...
        if (name && name.trim() && email && mobile && /[6-9]{1}[0-9]{9}/.test(mobile) && college) {
            try {
                setSubmitted(true)
                const response = await db.collection("robowar").add({
                    name: name || "",
                    email: email || "",
                    mobile: mobile || "",
                    college: college || "",
                            ...
                            <Col md="12">
                                <div className="registration-box">
                                    ...
                                    <form id="form_registration" className="form">
                                        ...
                                        <button disabled={submitted} onClick={submitDetails}>JOIN ROBO WAR NOW!!</button>
                                    </form>
