                                ...
                                <Col lg="8" md="12">
                                    <div className="product-list table-responsive">
                                        <Table className="table-bordered">
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td className="product-remove"><a href={"" + "/"}><i className="las la-trash"></i></a></td>
                                                    <td className="product-thumbnail"><a href={"" + "/"}><img src={"" + `/assets/images/product-01.jpg`} alt="" /></a></td>
                                                    <td className="product-title"><a href={"" + "/"}>Product Title Here ...</a></td>
                                                ...
                                                <tr>
                                                    <td className="product-remove"><a href={"" + "/"}><i className="las la-trash"></i></a></td>
                                                    <td className="product-thumbnail"><a href={"" + "/"}><img src={"" + `/assets/images/product-02.jpg`} alt="" /></a></td>
                                                    <td className="product-title"><a href={"" + "/"}>Product Title Here ...</a></td>
                                                ...
                                                <tr>
                                                    <td className="product-remove"><a href={"" + "/"}><i className="las la-trash"></i></a></td>
                                                    <td className="product-thumbnail"><a href={"" + "/"}><img src={"" + `/assets/images/product-03.jpg`} alt="" /></a></td>
                                                    <td className="product-title"><a href={"" + "/"}>Product Title Here ...</a></td>
                                        ...
                                        <div className="actions d-flex justify-content-between">
                                            ...
                                            <div className="update-cart">
                                                <a className="update-btn" href={"" + "/"}>Update cart</a>
                                            </div>
                                        </div>
                                    </div>
                                </Col>
